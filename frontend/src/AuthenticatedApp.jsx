...
const AuthenticatedApp = () => {
  ...
  const [users, setUsers] = useState([
    { id: 1, name: 'Usuário Admin', email: 'admin@example.com', user_type: 'admin' },
            ...
            <CardContent>
              <form onSubmit={handleSubmitIndication} className="space-y-4">
                ...
                {formData.segment === 'outros' && (
                  <div className="space-y-2">
                    <Label htmlFor="customSegment">Especifique o Segmento</Label>
                    <Input
                      id="customSegment"
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-green-400 rounded-lg shadow-md border p-6">
            ...
            <div className="p-6">
              <div className="text-2xl font-bold text-white">{ambassadorData.stats.total_indications}</div>
          ...
          <div className="bg-yellow-400 rounded-lg shadow-md border p-6">
            ...
            <div className="p-6">
              <div className="text-2xl font-bold text-gray-900">{ambassadorData.stats.approved_sales}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="bg-green-400">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-black">Comissões a Pagar no Mês</CardTitle>
